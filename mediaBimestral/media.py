...
print("A média do Bimestre foi : {} ".format(media))

if media >= 10.0:
    print("Parabéns sua média foi {}, você passou !!! ".format(media))
if (media >= 6.0 and media <= 9.0):
    print("Parabéns sua média foi {}, passou raspando !!! ".format(media))
if media <= 5.0:
